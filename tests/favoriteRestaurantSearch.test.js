...
describe('Searching restaurants', () => {
    ...
    describe('When query is not empty', () => {
        ...
        it('should show the name of the restaurants found by Favorite restaurants', (done) => {
            document.getElementById('restaurants').addEventListener('restaurants:updated', () => {
                const restaurantTitle = document.querySelectorAll('.item_title');

                expect(restaurantTitle.item(0).textContent).toEqual('restaurant abc');
                expect(restaurantTitle.item(1).textContent).toEqual('ada juga restaurant abcde');
                expect(restaurantTitle.item(2).textContent).toEqual('ini juga boleh restaurant a');
